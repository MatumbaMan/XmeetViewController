...
- (void)initMessage:(float)h
{
    ...
    bImage.image = [[XmeetTools getImageFromName:(type == 1 ? @"xmeet_message_mine" : @"xmeet_message_other")]resizableImageWithCapInsets:edge];
    ...
    head.image = [XmeetTools getImageFromName:@"ic_launcher"];
