...
- (void)initNavigation {
    ...
    //设置右按钮
    UIBarButtonItem * right = [[UIBarButtonItem alloc]initWithImage:[XmeetTools getImageFromName:@"xmeet_title_user"] style:UIBarButtonItemStylePlain target:self action:@selector(rename)];
    ...
    UIImage * im = [XmeetTools getImageFromName:@"xmeet_navigation_bar"];
    ...
    backImage.image = [XmeetTools getImageFromName:@"xmeet_back_arrow"];
...
- (void)initSendeView {
    ...
    _mSendView.backgroundColor = [UIColor colorWithPatternImage:[XmeetTools getImageFromName:@"xmeet_toolbar_bottom_bar"]];
